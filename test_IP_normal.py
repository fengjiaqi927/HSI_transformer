...
from train_IP_normal import HSIdata
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", default = './checkpoints/transformer_normal_speed/IP/4461_0.304312.pth')
    ...
    img = io.loadmat('./Datasets/IndianPines/IndianPines.mat')['imageCube']
